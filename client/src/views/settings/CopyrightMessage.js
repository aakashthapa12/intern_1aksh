...
//                     setCopyrightMessage(result.copyright?.copyrightMessage || '')
//                 } else {
//                     setConfigData(null);
//                 }
//             }
...
//         setLoading(true);
//         const data = {
//             copyright: copyrightMessage // Send copyright in the correct structure
//         };
...
//                 // Update configData after successful submission
//                 const updatedConfigData = { ...configData };
//                 updatedConfigData.copyright = { copyrightMessage };
...
//                                             <p>Copyright Message: {configData.copyright?.copyrightMessage || '-'}</p>
//                                         </div>
//                                     ) : (
//                                         <form>
//                                             <div className="row">
...
function CopyrightMessage() {
    ...
    const handleSubmit = async () => {
        setLoading(true);
        const data = {
            copyrightMessage // Send copyrightMessage directly
        };
